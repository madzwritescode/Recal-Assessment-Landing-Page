...
export default function Home() {
  ...
  const getCurrentMessage = () => {
    ...
    return message.replace(/\*\*(.*?)\*\*/g, '<strong class="text-[#0A4367] font-extrabold">$1</strong>');
  };
  ...
  return (
    <>
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 relative font-sans" style={{
      ...
      <div className="absolute inset-0 bg-[#F8FAFC]/90 z-0 pointer-events-none"></div>
      ...
      <header className="w-full relative z-10 px-4 pt-10">
        <div className="flex justify-center items-center">
          <Image
            ...
            width={160}
            height={80}
            className="h-16 w-auto recal-logo-navy"
          />
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8 relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-xl border border-[#A2C2C7]/30 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="space-y-8 flex flex-col justify-start lg:justify-between lg:h-full">
              <div className="space-y-6">
                {/* H1 Heading */}
                <h1 className="text-[36px] lg:text-6xl font-bold lg:leading-tight" style={{ color: '#0A4367', fontFamily: 'Rogue Sans Ext, sans-serif', fontStyle: 'italic', lineHeight: '1.15' }}>
                  Is Your Breathing Holding You Back?<br />
                  <span style={{ color: '#1b5d72' }}>Find out in 5 Minutes.</span>
                </h1>
                
                {/* Subtitle */}
                <div className="flex items-center gap-3">
                  <div className="flex items-center -space-x-1">
                    <svg className="w-5 h-5 flex-shrink-0 text-[#0A4367]" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-[16px] lg:text-lg text-slate-600" style={{ fontFamily: 'Roboto, sans-serif' }}>
                    Take our <span className="text-[#0A4367] font-semibold">free</span>, science-backed assessment to uncover the hidden metrics limiting your endurance, recovery, and focus.
                  </p>
                </div>
              </div>
              
              {/* Hero Form Container (Nested Card) */}
              <div className="bg-[#0A4367]/5 rounded-2xl border border-[#0A4367]/10 p-6 shadow-inner relative overflow-hidden h-[330px] flex flex-col justify-between">
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <input
                    ...
                    className="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#0A4367]/20 focus:border-[#0A4367] bg-white text-slate-800 placeholder-slate-400 focus:outline-none transition-all"
                    style={{ borderColor: '#CBD5E1', fontFamily: 'Rogue Sans Ext, sans-serif', fontStyle: 'italic', fontSize: '16px', height: '48px' }}
                    required
                  />
                  <input
                    type="email"
                  ...
                  <button
                    ...
                    className="w-full py-3 px-6 rounded-xl font-bold text-white bg-[#0A4367] hover:bg-[#105987] transition-all border border-[#0A4367]/25 shadow-md hover:shadow-[#0A4367]/15 cursor-pointer flex items-center justify-center"
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-center text-[15px] lg:text-sm italic text-[#0A4367]" style={{ fontFamily: 'Roboto, sans-serif', fontWeight: '500', fontStyle: 'italic' }}>
              ...
              <div className="block lg:hidden w-full bg-[#0A4367]/5 border border-[#0A4367]/10 rounded-2xl p-6 shadow-inner flex flex-col justify-between hover:border-[#0A4367]/20 transition-all duration-300 hover:shadow-[#0A4367]/5 relative overflow-hidden mt-6">
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="relative flex-shrink-0">
                      <div className="relative">
                        <Image
                          ...
                          width={64}
                          height={64}
                          className="w-16 h-16 rounded-full object-cover border-2 border-[#0A4367] shadow-md transition-transform duration-300 hover:scale-105"
                          unoptimized
                        />
                        {/* Video Symbol Badge */}
                        <span className="absolute -top-1.5 -right-1.5 bg-[#0A4367] text-white rounded-full p-1.5 shadow-md border border-white">
                    ...
                    <div className="space-y-1.5 text-left">
                      <p className="text-[10px] font-black text-[#0A4367] tracking-widest uppercase bg-[#0A4367]/10 px-2 py-0.5 rounded w-max">Personal Video Feedback</p>
                      <h3 className="text-base font-bold text-[#0A4367] leading-tight">Custom Review by Coach Anthony</h3>
                  ...
                  <div className="border-t border-[#0A4367]/10 pt-3 mt-3">
                    <p className="text-[10px] font-bold text-[#0A4367] uppercase tracking-wider mb-2">What you receive:</p>
                    <ul className="text-[11px] text-slate-600 space-y-2">
                      <li className="flex items-start gap-2">
                        <span className="text-[#0A4367] mt-0.5">📹</span>
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-[#0A4367] mt-0.5">🏔️</span>
            ...
            <div className="hidden lg:flex flex-col justify-between items-center lg:h-full space-y-6">
              <div className="space-y-6 w-full flex flex-col items-center">
                <div className="w-full max-w-sm h-[420px] rounded-2xl overflow-hidden border border-slate-200 shadow-2xl relative">
                  <Image
                    src="/hero-image.png"
                ...
                <div className="w-full max-w-sm bg-[#0A4367]/5 border border-[#0A4367]/10 rounded-xl p-4 shadow-inner h-24 flex items-center">
                  <div className="flex items-start space-x-3 w-full">
                    {getStatusIndicator()}
                    <p 
                      className="text-sm text-slate-600 leading-relaxed transition-all duration-500 overflow-hidden" 
              ...
              <div className="w-full max-w-sm bg-[#0A4367]/5 border border-[#0A4367]/10 rounded-2xl p-5 shadow-inner flex flex-col justify-between hover:border-[#0A4367]/20 transition-all duration-300 hover:shadow-[#0A4367]/5 h-[330px] relative overflow-hidden flex-shrink-0">
                <div className="flex items-start gap-4">
                  <div className="relative flex-shrink-0">
                    <div className="relative">
                      <Image
                ...
                <div className="border-t border-[#0A4367]/10 pt-3 mt-3">
                  <p className="text-[10px] font-bold text-[#0A4367] uppercase tracking-wider mb-1.5">What you receive:</p>
        ...
        <div className="block lg:hidden bg-white/95 backdrop-blur-xl border border-[#A2C2C7]/30 rounded-3xl p-6 shadow-2xl">
          ...
          <div className="bg-[#0A4367]/5 rounded-2xl border border-[#0A4367]/10 p-4 shadow-inner overflow-hidden">
                ...
                {partnerLogos.slice(0, 8).map((logo, index) => (
                  <div key={`mobile-first-${index}`} className="flex-shrink-0 flex items-center justify-center h-16 w-16">
                    <Image
                      ...
                      width={60}
                      height={60}
                      className="w-full h-full object-contain opacity-40 hover:opacity-85 transition-opacity duration-300 partner-logo-dark"
                      unoptimized
                    />
                  </div>
                ))}
        ...
        <div className="hidden lg:block bg-white/95 backdrop-blur-xl border border-[#A2C2C7]/30 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold mb-6" style={{ color: '#0A4367', fontFamily: 'Rogue Sans Ext, sans-serif', fontStyle: 'italic' }}>
              Trusted By Athletes of:
            </h2>
          </div>
          
          <div className="bg-[#0A4367]/5 rounded-2xl border border-[#0A4367]/10 p-8 shadow-inner overflow-hidden">
                ...
                {partnerLogos.map((logo, index) => (
                  <div key={`first-${index}`} className="flex-shrink-0 flex items-center justify-center h-36 w-36">
                    <Image
                      ...
                      width={150}
                      height={150}
                      className="w-full h-full object-contain opacity-40 hover:opacity-85 transition-all duration-300 partner-logo-dark"
                      unoptimized
                    />
                  </div>
                ))}
        ...
        <div className="bg-white/95 backdrop-blur-xl border border-[#A2C2C7]/30 rounded-3xl p-6 sm:p-10 lg:p-12 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch min-h-[600px]">
            ...
            <div className="space-y-8 flex flex-col justify-between h-full">
              ...
              <div className="w-full">
                <div
                  className="w-full aspect-video cursor-pointer rounded-2xl overflow-hidden border border-slate-200 shadow-2xl bg-[#0A4367]/5"
                  onClick={() => {
                    gtag.event({
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                <div className="rounded-xl p-4 md:p-6 shadow-inner border border-[#0A4367]/10 bg-[#0A4367]/5">
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-4 rounded-full flex items-center justify-center bg-[#0A4367]/20 border border-[#0A4367]/15">
                      <svg className="w-8 h-8 md:w-10 md:h-10 text-[#0A4367]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="12" cy="12" r="10"></circle>
                        <circle cx="12" cy="12" r="6"></circle>
                        <circle cx="12" cy="12" r="2"></circle>
                      </svg>
                    </div>
                    <h3 className="text-xs md:text-sm font-semibold text-[#0A4367] uppercase tracking-wider leading-snug" style={{ fontFamily: 'Rogue Sans Ext, sans-serif', fontStyle: 'italic' }}>
                ...
                <div className="rounded-xl p-4 md:p-6 shadow-inner border border-[#0A4367]/10 bg-[#0A4367]/5">
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-4 rounded-full flex items-center justify-center bg-[#0A4367]/20 border border-[#0A4367]/15">
                      <svg className="w-8 h-8 md:w-10 md:h-10 text-[#0A4367]" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="4" strokeMiterlimit="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="rounded-xl p-4 md:p-6 shadow-inner border border-[#0A4367]/10 bg-[#0A4367]/5">
                  <div className="text-center">
                    <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-2 md:mb-4 rounded-full flex items-center justify-center bg-[#0A4367]/20 border border-[#0A4367]/15">
                      <svg className="w-8 h-8 md:w-10 md:h-10 text-[#0A4367]" viewBox="0 0 32 32" fill="currentColor">
            ...
            <div className="space-y-12 flex flex-col justify-center h-full">
              <h3 className="text-[30px] lg:text-5xl font-bold leading-tight" style={{ color: '#0A4367', fontFamily: 'Rogue Sans Ext, sans-serif', fontStyle: 'italic' }}>
                The Science Behind the Recal Breath Index
              </h3>
              <p className="text-[16px] lg:text-lg leading-relaxed text-slate-600" style={{ fontFamily: 'Roboto, sans-serif' }}>
                The Recal Breath Assessment was created by Anthony Lorubbio after years of working with athletes at altitude and in endurance sports. It measures your breathing performance across five proven tests to give you a complete profile — what we call your <strong className="text-[#0A4367] font-bold">Recal Breath Index.</strong>
              </p>
              <p className="text-[16px] lg:text-lg leading-relaxed text-slate-600" style={{ fontFamily: 'Roboto, sans-serif' }}>
              ...
              <p className="text-[16px] lg:text-lg leading-relaxed font-bold text-[#0A4367]" style={{ fontFamily: 'Roboto, sans-serif' }}>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-[#A2C2C7]/20 bg-white/90 relative z-10">
